...
#Eerst even de miscoderingen incl. door verkeerde spelling rechtzetten#

levels(FVV$qr2_98_other)
...
mutate(
  ...
  is_mena_correctie = grepl(
    "aghantan|afghan|lebanes|iran|iraq|tunes",
    open_herkomst,
    ignore.case = TRUE
  ),
...
diversity_gender_lgbtq_vars <- c(
  ...
  "t_q10_3",
  "t_q10_4",
  #"t_q10_5", #deze hasthag-lijn weghalen als t_q10_5 meegeteld moet worden
  "t_q10_6",
  "t_q11_1",
  "t_q11_2",
  "t_q11_3",
...
#Tukey post-hoc test op de geschatte marginale gemiddelden

emm <- emmeans(lm_FVV, ~ Herkomst)
...
#Conclusie: analyse blijft overeind. Niet in het rapport opgenomen
